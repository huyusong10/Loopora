...
def test_agent_native_step_view_paths_prefer_split_contract_fields() -> None:
    step_view = {
        ...
        "capsule_path": "steps/capsule.json",
        "capsule_absolute_path": "/runs/steps/capsule.json",
    }
    ...
    assert agent_native_legacy_capsule_path_text(step_view) == "steps/capsule.json"


def test_agent_native_step_view_paths_keep_legacy_capsule_as_explicit_fallback() -> None:
    step_view = {
        "capsule_path": "steps/capsule.json",
        "capsule_absolute_path": "/runs/steps/capsule.json",
    }
    ...
    assert agent_native_step_view_path_text(step_view, legacy_fallback=True) == "steps/capsule.json"
    assert agent_native_step_contract_path_text(step_view) == "steps/capsule.json"
    assert agent_native_step_contract_path_text(step_view, absolute=True) == "/runs/steps/capsule.json"
...
def test_agent_native_step_view_artifact_paths_are_unique_and_write_split_paths_first() -> None:
    step_view = {
        ...
        "agent_step_view_path": "steps/agent_step_view.json",
        "step_contract_absolute_path": "/runs/steps/step_contract.json",
        "capsule_absolute_path": "/runs/steps/step_contract.json",
        "capsule_path": "steps/capsule.json",
    }
