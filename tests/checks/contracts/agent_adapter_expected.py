...
AGENT_ENTRY_GEN_CONTRACT_SNIPPETS = (
    ...
    "run the explicit `loopora agent",
    ...
    "do not compress away evidence modes, blockers, exception categories",
    ...
    "When plan output returns `loop_recovery=continue_alignment_dialogue`",
    ...
    "Use the message-only form while alignment, working-agreement confirmation, or Web review is still pending",
    "use the bundle-file form only after explicit confirmation",
    ...
    "put that answer into the next message-only `--message`",
    "appends to the existing planning conversation",
