...
AGENT_ENTRY_GEN_CONTRACT_SNIPPETS = (
    ...
    "Do not run project tests, proof commands, smoke checks, or baseline checks before the primary `loopora agent",
    ...
    "Do not make a message-only plan call as the first planning attempt",
    "create the candidate plan file in step 3",
    ...
    "run the required command with `--bundle-file`",
