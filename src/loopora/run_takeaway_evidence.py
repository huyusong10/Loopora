...
EVIDENCE_COVERAGE_COUNT_FIELDS = (
    ...
    "covered_required_target_count",
    "weak_required_target_count",
    "missing_required_target_count",
    "blocked_required_target_count",
    "advisory_target_count",
    "covered_advisory_target_count",
    "weak_advisory_target_count",
    "missing_advisory_target_count",
    "blocked_advisory_target_count",
    "artifact_ref_count",
    "residual_risk_count",
)
...
def empty_evidence_coverage() -> dict[str, Any]:
    return {
        ...
        "covered_required_target_count": 0,
        "weak_required_target_count": 0,
        "missing_required_target_count": 0,
        "blocked_required_target_count": 0,
        "advisory_target_count": 0,
        "covered_advisory_target_count": 0,
        "weak_advisory_target_count": 0,
        "missing_advisory_target_count": 0,
        "blocked_advisory_target_count": 0,
        "top_gaps": [],
