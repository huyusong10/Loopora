...
from loopora.agent_adapter_static_checks import prefix_loopora_command
...
_managed_adapter_status = managed_adapter_status
_not_implemented_status = not_implemented_adapter_status
...
_adapter_check_recovery = adapter_check_recovery
